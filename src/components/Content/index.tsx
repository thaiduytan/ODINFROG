  ...
  return (
    ...
    >
      <Stack style={{ overflow: "hidden" }} gap={0}>
        ...
        <Box style={{ overflow: "hidden" }} pos="relative" h="100%" w="100%">
          ...
          <Box className={classes.slideWrapper}>
            <ScrollArea h={"100%"} type="never" viewportRef={viewport}>
              <Box
              ...
              <Box className={classes.block_17}>
                <Image src="/bg_22_0.png" w="100%" fit="cover" />
                <Image
                  src="/bg_22_1.png"
                  w="100%"
                  fit="cover"
              ...
              <Box className={classes.block_18}>
                ...
                />
                <Image src="/bg_23_1.png" w="100%" fit="cover" />
              </Box>
              ...
              <Box className={classes.block_24}>
                <Image src="/bg_30_0.png" w="100%" fit="cover" />
                <Image
                  src="/bg_30_1.png"
                  w="100%"
                  fit="cover"
              ...
              <Box className={classes.block_25}>
                <Image src="/bg_31_0.png" w="100%" fit="cover" />
                <Image
                  src="/bg_31_1.png"
                  w="100%"
                  fit="cover"
              ...
              <Box className={classes.block_28}>
                <Image src="/bg_34_0.png" w="100%" fit="cover" />
                <Image
                  src="/bg_34_1.png"
                  w="100%"
                  fit="cover"
              ...
              <Box className={classes.block_29}>
                <Image src="/bg_35_0.png" w="100%" fit="cover" />
                <Image
                  src="/bg_35_1.png"
                  w="100%"
                  fit="cover"
              ...
              <Box className={classes.block_30} pos="relative">
                <Image src="/bg_36_0.png" w="100%" fit="cover" />
                <Image
                  src="/bg_36_1.png"
                  w="100%"
                  fit="cover"
                ...
                >
                  <Image
                    src="/socical_x.png"
                    w={{ base: 18, xs: 35, sm: 25, md: 35 }}
                    h={{ base: 18, xs: 35, sm: 30, md: 40 }}
                    fit="fill"
                  />
                </Box>
              </Box>
